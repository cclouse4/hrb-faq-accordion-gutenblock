...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('create-block/hrb-faq-accordion', {
  attributes: {
    questionContent: {
      type: 'string',
      source: 'html',
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"create-block/hrb-faq-accordion","version":"0.1.0","title":"HRB FAQ Accordion","category":"widgets","icon":"arrow-down-alt2","description":"Example static block scaffolded with Create Block tool.","supports":{"html":false},"textdomain":"hrb-faq-accordion","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
